  ...
  return (
    <div>
      <div className="container space-y-4 mx-auto px-4 py-24 md:px-6 lg:py-32 2xl:max-w-[1400px]">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Tuk.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Tuk, accessible from{" "}
              <a
                href="https://tuk.city"
        ...
        <h3 className="text-lg font-bold">Third party APIs</h3>
        <p>
          Tuk&apos;s use and transfer to any other app of information received
        ...
        <h3 className="text-lg font-bold">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-lg font-bold">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-lg font-bold">Disclosure of Your Personal Data</h3>
